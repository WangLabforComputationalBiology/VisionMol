...
namespace UMol
{
    public class Distance : MonoBehaviour
    {
        ...
        void Update()
        {
            if (Input.GetKey(KeyCode.LeftAlt) && Input.GetMouseButtonDown(0) && !UnityEngine.EventSystems.EventSystem.current.IsPointerOverGameObject())
            {
        ...
        GameObject CreateLineObject(Vector3 start, Vector3 end, float distance, Vector3 firstatom, Vector3 sencondatom)
        {
            ...
            //Vector3 offset = direction * -2f; // 调整偏移量
        ...
        //void OnGUI()
        //{
        //    GUILayout.BeginArea(new Rect(10, 210, 200, 200));
        //    GUILayout.Label("Distances");
        //    for (int i = 0; i < distances.Count; i++)
        //    {
        //        GUILayout.Label($"Distance {i + 1}: {distances[i]:F3} Å");
        //    }
        //    GUILayout.EndArea();
        //}
